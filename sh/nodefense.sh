...
python main.py --config conf_20 --model vgg11 --n_client 20 --defense fedavg --attack noatt --dataset cifar10 --wandb --task cifar_resnet_20
python main.py --config conf_20 --model vgg11 --n_client 20 --defense deepsight --attack noatt --dataset cifar10 --wandb --task cifar_resnet_20
python main.py --config conf_20 --model vgg11 --n_client 20 --defense foolsgold --attack noatt --dataset cifar10 --wandb --task cifar_resnet_20
python main.py --config conf_20 --model vgg11 --n_client 20 --defense mkrum --attack noatt --dataset cifar10 --wandb --task cifar_resnet_20
python main.py --config conf_20 --model vgg11 --n_client 20 --defense rlr --attack noatt --dataset cifar10 --wandb --task cifar_resnet_20
